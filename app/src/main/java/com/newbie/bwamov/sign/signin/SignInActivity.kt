package com.newbie.bwamov.sign.signin
...
import com.newbie.bwamov.home.HomeActivity
import com.newbie.bwamov.R
import com.newbie.bwamov.sign.signup.SignUpActivity
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_home.setOnClickListener {
            ...
            if (iUsername.equals("")){
                ...
                if (statusUsername >= 0){
                    et_username.error = "Silahkan isi username anda tanpa tanda ."
                    et_username.requestFocus()
                }else{
